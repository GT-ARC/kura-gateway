...
public class CoapGatewayServer extends CoapServer  {
    ...
    public  void addEndpoints() {
        ...
        InetSocketAddress bindToAddress = new InetSocketAddress("172.24.1.1", COAP_PORT);
        addEndpoint(new CoAPEndpoint(bindToAddress));
    }
    ...
    class HelloWorldResource extends CoapResource {
        ...
        public void handlePOST(CoapExchange exchange) {
        	...
        	//message type : Deactivation
        		...
        		System.out.println("Got a Agent-Registration send request");
        		exchange.respond("Message with topic " + Type + " and payload " + rawMessage.toString() + " is sent to broker.");
        	}
        }
